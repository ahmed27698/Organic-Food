...
export default function page({ params }) {
    const { locale } = params;
    const t = useTranslations('Services_Details');
            ...
            <div className='relative'>
                ...
                <div className='absolute w-full bottom-0 lg:p-20 md:p-10 p-5 flex flex-col md:flex-row md:justify-between items-start  md:items-center'>
                    <div>
                        ...
                        <p className='text-white font-bold lg:text-6xl md:text-4xl text-2xl'>{t("ServiceDetails")}</p>
                    </div>
                    <div className='flex gap-4'><Link href='/' className='text-white font-bold'>{t("Home")}</Link><span className='text-white'>|</span><p className='text-green-600 font-bold'>{t("ServiceDetails")}</p></div>
                </div>
            </div>
            <section className="lg:px-20 md:px-10 px-4 flex flex-col my-16">
                <img src="https://broccolisite.netlify.app/assets/mainPhoto-BCB0CUcP.webp" alt="image" />
                <div className="flex gap-5 my-5">
                    <span className="bg-green-600 text-white text-6xl py-5 px-7 font-bold">{t("Letter")}</span>
                    <p>
                        {t("CarefullySelectedProducts")}
                    </p>
                </div>
                <p>
                    {t("DeliveryService")}
                ...
                <div className="flex md:flex-row flex-col gap-5 justify-center">
                    <img className="md:w-5/12" src="https://broccolisite.netlify.app/assets/food1-NhSkRrMP.webp" alt="image" />
                    <img className="md:w-5/12" src="https://broccolisite.netlify.app/assets/food2-CuvpQZAT.webp" alt="image" />
                </div>
                <div className="mt-10">
                    <p>{t("CustomerSupport")}</p>
                    <p className="mt-10">{t("EcoFriendlyFarms")}</p>
                </div>
            </section>

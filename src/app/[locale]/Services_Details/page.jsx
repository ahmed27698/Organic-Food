        ...
        <section>
            ...
            <div className='relative'>
                ...
                <div className='absolute w-full bottom-0 lg:p-20 md:p-10 p-5 flex flex-col md:flex-row md:justify-between items-start  md:items-center'>
                    <div>
                        ...
                        <p className='text-white font-bold lg:text-6xl md:text-4xl text-2xl'>Service Details</p>
                    </div>
                    <div className='flex gap-4'><Link href='/' className='text-white font-bold'>Home</Link><span className='text-white'>|</span><p className='text-green-600 font-bold'>Service Details</p></div>
                </div>
            </div>
            <section className="lg:px-20 md:px-10 px-4 flex flex-col my-16">
                ...
                <div className="flex gap-5 my-5">
                    <span className="bg-green-600 text-white text-6xl py-5 px-10 font-bold">L</span>
                    <p>

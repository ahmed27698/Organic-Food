...
export default function NavBarPages(props) {
    ...
    return (
        <nav className="lg:px-20 md:px-10 px-4 py-5 fixed left-0 w-screen z-9 flex md:flex-row flex-col items-center justify-between bg-[#081B1E] text-white">
                            ...
                            dropdownLinks[index - 1] && (
                                <ul className="absolute border-green-600 border-t-4 top-15 left-0 z-10 bg-white shadow-xl px-10 w-52 py-3 flex flex-col gap-3">
                                    {dropdownLinks[index - 1].map((ddLink) => (
                                        <Link
                                            href={`/${ddLink.link}`}
                                            className="hover:text-green-600 text-black duration-200 cursor-pointer font-medium"
                                            key={ddLink.labelKey}
                                        >
                                            {t(ddLink.labelKey)}
                                        </Link>
                            ...
                            <div className="flex flex-col">
                                ...
                                {session ? (
                                    ...
                                    <>
                                        <Link
                                            href="/Sign_In"
                                            className="hover:text-green-600 p-4 font-medium flex items-center border-b border-gray-200"
                                        >
                                            {t("signIn")}
                                        </Link>
                                        <Link

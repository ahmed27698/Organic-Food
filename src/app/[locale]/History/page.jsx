            ...
            <div className='relative'>
                ...
                <div className='absolute w-full bottom-0 lg:p-20 md:p-10 p-5 flex flex-col md:flex-row md:justify-between items-start  md:items-center'>
                    <div>
                        ...
                        <p className='text-white font-bold lg:text-6xl md:text-4xl text-2xl'>Our History</p>
                    </div>
                    <div className='flex gap-4'><Link href='/' className='text-white font-bold'>Home</Link><span className='text-white'>|</span><p className='text-green-600 font-bold'>History</p></div>
                </div>
            </div>
            <Tabs/>
            <div className="bg-[#071C1F] justify-center items-center flex flex-col py-15 lg:px-20 md:px-10 px-4">
                <p className="text-green-600 font-bold">// features //</p>
                <p className="font-extrabold lg:text-6xl md:text-4xl text-2xl text-white">Why Choose Us<span className="text-green-600">.</span></p>
                <div className="my-10 flex justify-center items-center flex-col md:flex-row gap-5">
                    <div className="flex-col flex justify-between items-center p-5 border-2 border-white grow">
                        <div className="flex justify-center items-center gap-10">
                            <FaCarBattery className="text-6xl text-green-600"/>
                            <Link href='./Team' className="font-bold text-white hover:text-green-600 duration-500 text-2xl">Reasonable Price</Link>
                        </div>
                        <p className="font-medium my-5 text-white">Lorem ipsum dolor sit amet, consect etur adipisicing elit, sed do eiusmod tempor incididunt ut labore.</p>
                    </div>
                    <div className="flex-col flex justify-between items-center p-5 border-2 border-white grow">
                        <div className="flex justify-center items-center gap-10">
                            <FaUserSecret className="text-6xl text-green-600"/>
                            <Link href='./Team' className="font-bold text-white hover:text-green-600 duration-500 text-2xl">Expert Mechanics</Link>
                        </div>
                        <p className="font-medium my-5 text-white">Lorem ipsum dolor sit amet, consect etur adipisicing elit, sed do eiusmod tempor incididunt ut labore.</p>
                    </div>
                    <div className="flex-col flex justify-between items-center p-5 border-2 border-white grow">
                        <div className="flex justify-center items-center gap-10">
                            <TbTruckDelivery className="text-6xl text-green-600"/>
                            <Link href='./Team' className="font-bold text-white hover:text-green-600 duration-500 text-2xl">Fast Feature Delivery</Link>
                        </div>
                        <p className="font-medium my-5 text-white">Lorem ipsum dolor sit amet, consect etur adipisicing elit, sed do eiusmod tempor incididunt ut labore.</p>
                    </div>
                </div>

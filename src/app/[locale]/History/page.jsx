    ...
    return (
        <section dir={locale === "ar" ? "rtl" : "ltr"}>
            ...
            <div className="relative">
                ...
                <div className="absolute w-full bottom-0 lg:p-20 md:p-10 p-5 flex flex-col md:flex-row md:justify-between items-start  md:items-center">
                    ...
                    <div className="flex gap-4">
                        ...
                        <p className="text-green-600 font-bold">{t("History")}</p>
                    </div>
                </div>
            </div>
            <Tabs />
            ...
            <div className="bg-[#071C1F] justify-center items-center flex flex-col py-15 lg:px-20 md:px-10 px-4">
                ...
                <p className="font-extrabold lg:text-6xl md:text-4xl text-2xl text-white">
                    {t("WhyChooseUs")}
                ...
                <div className="my-10 flex justify-center items-center flex-col md:flex-row gap-5">
                    <div className="flex-col flex justify-between items-center p-5 border-2 border-white grow">
                        <div className="flex justify-center items-center gap-10">
                            ...
                            <Link
                                href="./Team"
                                className="font-bold text-white hover:text-green-600 duration-500 text-2xl"
                            >
                                {t("ReasonablePrice")}
                            </Link>
                        </div>
                        <p className="font-medium my-5 text-white">
                            {t("ReasonablePriceDesc")}
                        </p>
                    </div>
                    <div className="flex-col flex justify-between items-center p-5 border-2 border-white grow">
                        <div className="flex justify-center items-center gap-10">
                    ...
                    <div className="flex-col flex justify-between items-center p-5 border-2 border-white grow">
                        <div className="flex justify-center items-center gap-10">
                            ...
                            <Link
                                ...
                                className="font-bold text-white hover:text-green-600 duration-500 text-2xl"
                            >
                                {t("FastFeatureDelivery")}
                            </Link>
                        </div>
                        <p className="font-medium my-5 text-white">
                            {t("FastFeatureDeliveryDesc")}
                        </p>
                    </div>
                </div>
            </div>

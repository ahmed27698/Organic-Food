...
import { FaLocationArrow , FaFacebookF , FaTiktok, FaStar } from "react-icons/fa";
      ...
      <div className='relative'>
          ...
          <div className='absolute w-full bottom-0 lg:p-20 md:p-10 p-5 flex flex-col md:flex-row md:justify-between items-start  md:items-center'>
              <div>
                  ...
                  <p className='text-white font-bold lg:text-6xl md:text-4xl text-2xl'>Product Details</p>
              </div>
              <div className='flex gap-4'><Link href='/' className='text-white font-bold'>Home</Link><span className='text-white'>|</span><p className='text-green-600 font-bold'>{product.title}</p></div>
          </div>
      </div>
      <div className="flex lg:px-20 md:px-10 px-4 my-10">
        <img src={product.thumbnail} alt="image" className="grow"/>
        <div className="flex flex-col justify-center items-center grow gap-5">
          ...
          <div className="flex justify-center items-center">
            <p>Share : </p>
            <div className='flex gap-2'><FaFacebookF  className="hover:text-green-600"/><FaTiktok  className="hover:text-green-600"/><BsInstagram  className="hover:text-green-600"/><BsTwitterX className="hover:text-green-600"/></div>
          </div>
          <p>Guaranteed Safe Checkout</p>
          <img src="https://broccolisite.netlify.app/assets/payment-CV7CJQxC.webp" alt="visa image" />
        </div>
      </div>
      <div className="lg:px-20 md:px-10 px-4 mb-10">
        <p>description</p>
        <p>
          {product.description}
        </p>

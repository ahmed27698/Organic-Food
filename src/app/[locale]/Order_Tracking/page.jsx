            ...
            <div className='relative'>
                ...
                <div className='absolute w-full bottom-0 lg:p-20 md:p-10 p-5 flex flex-col md:flex-row md:justify-between items-start  md:items-center'>
                    <div>
                        ...
                        <p className='text-white font-bold lg:text-6xl md:text-4xl text-2xl'>Order Tracking</p>
                    </div>
                    <div className='flex gap-4'><Link href='/' className='text-white font-bold'>Home</Link><span className='text-white'>|</span><p className='text-green-600 font-bold'>Order Tracking</p></div>
                </div>
            </div>
            <div className="my-20 lg:w-6/12 md:w-8/12 w-full mx-auto py-14 bg-[#F7F5EB] px-10 flex items-center justify-center flex-col gap-3">
                ...
                <p className="self-start">Order ID</p>
                <input type="text" className="w-full p-5 outline-1 outline-white focus:outline-green-600" placeholder="Found In Your Order Confirmation Email." />
                <p className="self-start">Billing email</p>
                <input type="text" className="w-full p-5 outline-1 outline-white focus:outline-green-600" placeholder="Email You Used During Checkout" />
                <button className="p-5 bg-green-600 text-white font-bold ">Track Order</button>
            </div>

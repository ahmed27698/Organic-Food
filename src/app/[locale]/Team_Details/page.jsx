            ...
            <div className='relative'>
                ...
                <div className='absolute w-full bottom-0 lg:p-20 md:p-10 p-5 flex flex-col md:flex-row md:justify-between items-start  md:items-center'>
                    <div>
                        ...
                        <p className='text-white font-bold lg:text-6xl md:text-4xl text-2xl'>Team Details</p>
                    </div>
                    <div className='flex gap-4'><Link href='/' className='text-white font-bold'>Home</Link><span className='text-white'>|</span><p className='text-green-600 font-bold'>Team Details</p></div>
                </div>
            </div>
            <div className="lg:px-20 md:px-10 px-4 my-10 flex md:flex-row flex-col gap-10">
                <div className="md:w-4/12 w-full flex flex-col items-center gap-3">
                    <img src="https://broccolisite.netlify.app/assets/adam-D8LrdnbM.webp" alt="image" />
                    <p className="font-bold">Rosalina D. William</p>
                    <p className="font-bold text-green-600">Founder</p>
                ...
                <div className="md:w-8/12 w-full">
                    ...
                    <div className="my-10">
                        ...
                        <div className="flex md:gap-5 ">
                            <p className='font-bold'>Practice Area:</p>
                            <p>Car Repair</p>
                        </div>
                        <div className="flex md:gap-5 ">

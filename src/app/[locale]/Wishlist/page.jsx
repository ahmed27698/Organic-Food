...
import { WhishList } from '../clientPage'
...
export default function page() {
    ...
    const t3 = useTranslations("whishList");
    return (
        <section>
            <NavBarPages navLink='/'/>
            <div className='relative'>
                ...
                <div className='absolute w-full bottom-0 lg:p-20 md:p-10 p-5 flex flex-col md:flex-row md:justify-between items-start  md:items-center'>
                    <div>
                        ...
                        <p className='text-white font-bold lg:text-6xl md:texJt-4xl text-2xl'>{t3("WhishList")}</p>
                    </div>
                    <div className='flex gap-4'><Link href='/' className='text-white font-bold'>{t("Home")}</Link><span className='text-white'>|</span><p className='text-green-600 font-bold'>{t3("WhishList")}</p></div>
                </div>
            </div>
            <WhishList/>

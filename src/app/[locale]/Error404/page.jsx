            ...
            <div className='relative'>
                ...
                <div className='absolute w-full bottom-0 lg:p-20 md:p-10 p-5 flex flex-col md:flex-row md:justify-between items-start  md:items-center'>
                    <div>
                        ...
                        <p className='text-white font-bold lg:text-6xl md:text-4xl text-2xl'>404</p>
                    </div>
                    <div className='flex gap-4'><Link href='/' className='text-white font-bold'>Home</Link><span className='text-white'>|</span><p className='text-green-600 font-bold'>404</p></div>
                </div>
            </div>
            <div className="py-30 text-center">
                <h2 className="font-extrabold text-9xl text-green-600 text-center">
                    404
                </h2>
                <p className="font-bold mt-4">Page Not Found!</p>
                <p className="block">Oops! The page you are looking for does not exist. It might have been moved or deleted.</p>
                <button>
                    <Link href='/' className="p-5 flex items-center justify-center border-1 font-bold gap-2 mt-4 border-black bg-white text-black hover:text-white hover:bg-green-600"><BsArrowLeft/> Back To Home</Link>
                </button>
            </div>

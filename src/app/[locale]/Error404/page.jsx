        ...
        <section dir={locale === "ar" ? "rtl" : "ltr"}>
            ...
            <div className='relative'>
                ...
                <div className='absolute w-full bottom-0 lg:p-20 md:p-10 p-5 flex flex-col md:flex-row md:justify-between items-start  md:items-center'>
                    ...
                    <div className='flex gap-4'><Link href='/' className='text-white font-bold'>{t("Home")}</Link><span className='text-white'>|</span><p className='text-green-600 font-bold'>{t("404")}</p></div>
                </div>
            </div>
            <div className="py-30 text-center">
                ...
                <p className="font-bold mt-4">{t("PageNotFound")}</p>
                <p className="block">{t("OopsMessage")}</p>
                <button>
                    <Link href='/' className="p-5 flex items-center justify-center border-1 font-bold gap-2 mt-4 border-black bg-white text-black hover:text-white hover:bg-green-600"><BsArrowLeft/> {t("BackToHome")}</Link>
                </button>
            </div>

        ...
        <section>
            ...
            <div className='relative'>
                ...
                <div className='absolute w-full bottom-0 lg:p-20 md:p-10 p-5 flex flex-col md:flex-row md:justify-between items-start  md:items-center'>
                    <div>
                        ...
                        <p className='text-white font-bold lg:text-6xl md:text-4xl text-2xl'>Our Experts</p>
                    </div>
                    <div className='flex gap-4'><Link href='/' className='text-white font-bold'>Home</Link><span className='text-white'>|</span><p className='text-green-600 font-bold'>Team</p></div>
                </div>
            </div>
            <section className="lg:px-20 md:px-10 px-4 my-16">
                ...
                <div className="flex flex-wrap gap-20 justify-center">
                    {experts.map((expert)=>(
                        <div className="shadow flex flex-col lg:w-2/12 md:w-3/12 w-full" key={expert.name}>
                            <img src={expert.image} alt="image" />
                            <p className="text-center pt-2pnp text-green-600">{expert.position}</p>
                            <p className="text-center p-4 ">{expert.name}</p>
            ...
            <section className="flex lg:px-20 md:px-10 px-4 md:flex-row flex-col my-16 justify-center gap-8">
                <div className="md:w-5/12 w-full">
                    <p className="text-green-600 font-bold">// skills</p>
                    <p className="lg:text-5xl md:text-4xl text-2xl font-bold">We Have A Skillest Team Ever<span className="text-green-600">.</span></p>
                ...
                <img src="https://broccolisite.netlify.app/assets/bigimgteam-Cg_4g6FX.webp" alt="image" className="md:w-6/12 w-full" />
            </section>

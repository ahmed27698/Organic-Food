        ...
        <section dir={locale === "ar" ? "rtl":"ltr"}>
            ...
            <div className="relative">
                ...
                <div className="absolute w-full bottom-0 lg:p-20 md:p-10 p-5 flex flex-col md:flex-row md:justify-between items-start md:items-center">
                    ...
                    <div className="flex gap-4">
                        ...
                        <p className="text-green-600 font-bold">{t("Team")}</p>
                    </div>
                </div>
            </div>
            ...
            <section className="lg:px-20 md:px-10 px-4 my-16">
                ...
                <div className="flex flex-wrap gap-20 justify-center">
                    {experts.map((expert) => (
                        <div
                            className="shadow flex flex-col lg:w-2/12 md:w-3/12 w-full"
                            key={expert.name}
                        >
                            <img src={expert.image} alt={expert.name} />

                            <p className="text-center pt-2 text-green-600">
                                {t(expert.positionKey)}
                            </p>
            ...
            <section className="flex lg:px-20 md:px-10 px-4 md:flex-row flex-col my-16 justify-center gap-8">
                <div className="md:w-5/12 w-full">
                    <p className="text-green-600 font-bold">// {t("Skills")}</p>
                    ...
                    <p className={`after:content-[""] after:h-12 after:w-1 after:bg-green-600 after:absolute  after:top-0 relative px-5 my-10 ${locale === "ar" ? "after:right-0" : "after:left-0"}`}>
                        {t("TeamDesc")}
                    </p>
                ...
                <img
                    src="https://broccolisite.netlify.app/assets/bigimgteam-Cg_4g6FX.webp"
                    alt="image"

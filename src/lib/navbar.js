export const navBar = {
  ...
  newsLinks: [
    { labelKey: 'news', link: 'News' },
    { labelKey: 'newsDetails', link: 'News_Details' }
  ],
  pagesLinks: [
    { labelKey: 'history', link: 'History' },
    { labelKey: 'contact', link: 'Contact' },
    { labelKey: 'error404', link: 'Error404' }
  ]
};
